      ...
      <div class="nav-in">
        <div class="nav-left">
          ...
          <NuxtLink :to="localePath('/')" class="nav-logo">
            <img
              ...
              height="100"
              loading="lazy"
              :src="footerData?.data?.data?.footer?.logo"
              alt="Logo"
            />
          </NuxtLink>
        </div>
        ...
        <div class="nav-right">
          <div class="nav-menu">
            ...
            <NuxtLink
              :to="localePath('/about')"
              :class="{ active: $route.path === localePath('/about') }"
              class="nav-menu__item"
              >{{ $t("about") }}</NuxtLink
            >
            <NuxtLink
              :to="localePath('/category')"
              :class="{ active: $route.path === localePath('/category') }"
              class="nav-menu__item"
              >{{ $t("category") }}</NuxtLink
            >
            <NuxtLink
              :to="localePath('/services')"
              :class="{ active: $route.path === localePath('/services') }"
              class="nav-menu__item"
              >{{ $t("services") }}</NuxtLink
            >
            <NuxtLink
              :to="localePath('/blog')"
              :class="{ active: $route.path === localePath('/blog') }"
              class="nav-menu__item"
              >{{ $t("blog") }}</NuxtLink
            >
            <NuxtLink
          ...
          <div class="nav-actions">
            ...
            <NuxtLink :to="localePath('/saved')" class="nav-saved">
              <IconsHeart />
              <span class="nav-saved__count">{{
                store?.favoriteItems?.length
              }}</span>
            </NuxtLink>
